    ...
    <Stack gap={1} alignItems={'center'}>
      ...
      <Container maxWidth="sm">
        ...
        <P level="body-sm">
          ...
          Think of your wallet passphrase as an extra lock on your wallet. Your
          recovery words are the key, and the passphrase is the secret code that
          makes the key work. For best security, keep the passphrase stored
          separately from your recovery words — ideally only in your mind.
        </P>
        <PassphraseInput
